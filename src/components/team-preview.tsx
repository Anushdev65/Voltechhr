      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mb-8">
          {teamMembers.map((member, index) => (
            <div
              key={index}
              className="p-4 sm:p-6 lg:p-8 bg-background rounded-lg border border-border hover:border-primary/30 transition-colors"
            >
              <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-linear-to-br from-primary to-primary/60 rounded-full mb-3 sm:mb-4 flex items-center justify-center shrink-0">
