          ...
          <div className="relative z-10 h-full">
            <div className="max-w-7xl mx-auto h-full px-4 sm:px-6 lg:px-8 flex flex-col justify-center">
              ...
              <p className="max-w-2xl text-sm sm:text-base md:text-lg text-white/85">
                Pioneering workforce solutions with integrity, transparency, and
                a commitment to globally competitive Nepali talent.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                ...
                <div className="space-y-4 text-sm sm:text-base text-foreground/80 leading-relaxed">
                  ...
                  <p>
                    The company is licensed by the Ministry of Labour &
                    Transport Management, Department of Foreign Employment, with
                    License No. 1799/082/083. This authorization empowers us to
                    supply professional manpower to international markets while
            ...
            <div className="max-w-4xl">
              ...
              <div className="space-y-4 text-sm sm:text-base text-foreground/80 leading-relaxed">
                <p>
                  ...
                  organizations must stay aligned with emerging trends,
                  especially in securing talent equipped with the right skills
                  to maintain seamless operations and achieve peak productivity.
                </p>
                <p>
                  ...
                  professionally managed platform to channel Nepal&apos;s vast
                ...
                <p>
                  ...
                  international employers with qualified Nepali professionals
                  who are ready to contribute and grow.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
              ...
              <div className="p-6 sm:p-7 bg-white rounded-xl border border-border shadow-sm hover:shadow-lg transition-shadow">
                ...
                <p className="text-sm sm:text-base text-foreground/80 leading-relaxed">
                  Our vision is to be recognized as Nepal&apos;s most trusted
                  and progressive manpower provider, known for connecting the
                  right people to the right opportunities across global
                  industries. We aim to continually enhance our expertise,
                  expand our global footprint, and empower Nepali talent by
